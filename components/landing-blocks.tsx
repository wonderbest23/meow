...
export function LandingBlocksRenderer({ data, preloaded }: { data: LandingPageData; preloaded?: BrainwavePageData | null }) {
  ...
  if (data.brainwave) {
    return <BrainwavePage pageId={data.brainwave.page} overrides={{ texts: data.brainwave.texts, images: data.brainwave.images, links: data.brainwave.links, sizes: data.brainwave.sizes, hidden: data.brainwave.hidden, order: data.brainwave.order }} preloaded={preloaded} />;
  }
