...
async function main() {
  ...
  const numberedSummary = renderToStaticMarkup(<BusinessSummary snapshot={numbered} disabled={false} aiBusy={false} prepared={false} onEdit={noop} onDetails={noop} onDesign={noop} onPrepare={noop} />);
