...
suites.push("landing-editor-async", "landing-source-update", "landing-lead-notifications", "document-editorial", "executive-summary");
suites.push("artifact-updates", "proposal-v3");
suites.push("artifact-update-matrix", "landing-image-crop");
suites.push("artifact-update-reservations");
suites.push("artifact-v3-operating");
suites.push("proposal-source-staleness");
