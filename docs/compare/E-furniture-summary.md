...
- 사업 유형: 제조·생산
- 핵심 고객: 소형 카페 운영자
- 고객의 문제: 기성 가구가 좁은 카페 공간에 맞지 않아 좌석 수가 줄어든다
...
- 전달 방식: 직접 제작 후 현장 납품·설치 (추정)

이 사업 구조에서 생각할 것(관점 힌트이지 사실이 아님):
- 1회성 판매: 판매 단가·월 판매 건수·건당 원가·고정비가 핵심이다.

계산된 재무 핵심값(시스템 계산 — 다시 계산하지 말고 인용만):
- 판매가 1,800,000원 / 변동비 700,000원 / 건당 공헌이익 1,100,000원 (이익률 61.1%)
- 손익분기: 월 2건 (매출 3,600,000원)
- 12개월 합계: 매출 86,400,000원, 영업손익 38,400,000원
- 월 흑자 전환: 1개월차
