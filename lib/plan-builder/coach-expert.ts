import { z } from "zod";
import { COACH_KEY, coachFieldSchema, coachDocumentRevision, readCoach, type CoachState } from "./coach";
...
export function expertChanges(coach: CoachState, patch: Pick<ExpertPatch, "title" | "fields">): ExpertChange[] {
