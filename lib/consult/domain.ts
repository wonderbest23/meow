...
export const CONSULT_SYSTEM = [
  ...
  '{"message":"경기도에 5천만원이면 선택지가 있어요. 매장에 하루 몇 번 정도 들르실 수 있으세요?",',
  ' "profile":{"region":"경기","budget":"5000만원","unmanned":"선호"},',
  ' "choices":["하루 1~2번","주 2~3번","거의 못 감"],"summary":[],"picks":[],"ready":false}',
