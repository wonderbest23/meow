...
const stageInstructions = [
  "사업 실행 브리프를 생성하세요. problem, customer, valueProposition, constraints, validationPlan, day21Goal을 포함하세요. 이 사업이 무엇이고 누구에게 어떤 가치를 주는지, 처음 다룰 범위와 준비 조건이 드러나게 사업의 전체 틀을 세우는 데 집중하세요. validationPlan과 day21Goal은 고객 검증을 강요하는 대신 사업을 구체화하려고 정하거나 만들 것을 순서와 완료 기준과 함께 담고, 고객 확인은 준비되면 진행할 선택 단계로 표현하세요.",
  "고객·시장 진단서를 생성하세요. primaryCustomer, jobs, pains, currentAlternatives, evidence, interviewScript, unknowns를 포함하세요. 목표 고객과 문제, 현재 대안, 가격 감각을 구체적으로 정의하는 데 집중하고 jobs·pains·대안·미확인 사항은 각각 3개 이상 작성하세요. interviewScript는 창업가가 원할 때 활용할 확인용 질문 8개 이상으로, 강요가 아니라 선택 도구로 제시하세요.",
  "상품·가격·손익안을 생성하세요. 3개 tiers, unitEconomics, breakEvenCustomers, assumptions, pricingTests를 포함하세요. 모든 금액은 산식·포함범위·확인상태를 구분하고 보수·기준·낙관 시나리오를 제시하세요.",
  ...
  "실행 계획 패키지를 생성하세요. outreachScripts, channelPlan, weeklyMetrics, supportProgramChecklist, next30Days를 포함하세요. next30Days는 사업을 실제로 굴리기 위한 준비와 실행 순서를 날짜·행동·담당·완료 기준과 필요 시 중단·조정 기준이 드러나게 12개 이상 담고, 결제·고객 반응 확인은 준비되면 시작할 선택 단계로 표현하세요.",
] as const;
...
function fallbackContent(project: ProjectRecord, stageIndex: number) {
  ...
  return {
    ...
    next30Days: [
      ...
      "28일: 개인정보, 환불, 작업 누락, 수익성을 체크리스트로 점검합니다.",
