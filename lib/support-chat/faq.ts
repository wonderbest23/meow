...
export const supportFaqCategories: SupportFaqCategory[] = [
  {
    ...
    items: [
      ...
      { id: "start-modes", question: "두 가지 시작 방법은 무엇이 다른가요?", answer: "‘질문으로 찾기’는 선택형 질문 8개로 성향을 찾아 사업 후보를 추천하고, ‘내 아이디어로 바로 기획’은 이미 정한 아이디어를 예산·시간과 함께 기획합니다.", keywords: ["두 가지", "2가지", "차이", "질문으로 찾기", "아이디어로 기획"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "files-final", question: "언제 최종 결과물이 완성되나요?", answer: "결제하면 기획안과 파일(사업 문서·발표자료·재무·홈페이지)이 자동으로 한 번에 제작되어 완성 화면에서 파일별로 정리됩니다. 단계별로 직접 진행할 필요가 없습니다.", keywords: ["최종 결과", "언제 완성", "완성본", "완료"] },
...
export const supportPlatformFacts = [
  "오늘창업의 시작 방법은 두 가지입니다. ‘질문으로 찾기’는 선택형 질문 8개와 예산·가능 시간을 바탕으로 사업 후보를 추천합니다. ‘내 아이디어로 바로 기획’은 아이디어·예산·주당 시간을 받아 사업 초안을 만듭니다.",
