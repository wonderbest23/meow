...
export const supportFaqCategories: SupportFaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: "pay-price", question: "가격은 얼마인가요?", answer: "모든 문서 유형이 동일하게 1부당 149,000원입니다. 1회 결제이며 구독이 아닙니다.", keywords: ["가격", "얼마", "비용", "요금"], link: { href: "/plan/start", label: "유형별 가격 보기" } },
...
export const supportPlatformFacts = [
  ...
  "가격은 모든 문서 유형 동일 1부당 149,000원, 1회 결제입니다. 구독이 아니며 한 계정에서 문서마다 따로 결제할 수 있습니다. 같은 사업으로 새 문서를 만들면 답변을 이어받을지 새로 시작할지 선택할 수 있습니다.",
