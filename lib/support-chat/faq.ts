...
export const supportFaqCategories: SupportFaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: "pay-price", question: "가격은 얼마인가요?", answer: "문서 유형별로 다릅니다. 간단 사업계획서 49,000원, 내부용 사업계획서·창업 초기 재무 예측 89,000원, 그 외(창업 초기·성장 확장·정밀 재무 모델·정부지원 PSST)는 모두 149,000원입니다. 문서 1부당 1회 결제이며 구독이 아닙니다.", keywords: ["가격", "얼마", "비용", "요금"], link: { href: "/plan/start", label: "유형별 가격 보기" } },
...
export const supportPlatformFacts = [
  ...
  "가격은 문서 1부당 1회 결제입니다. 간단 사업계획서 49,000원, 내부용 사업계획서 89,000원, 창업 초기 재무 예측 89,000원, 창업 초기 사업계획서 149,000원, 성장·확장 사업계획서 149,000원, 정밀 재무 모델 149,000원, 정부지원 PSST 사업계획서 149,000원. 구독이 아니며 한 계정에서 문서마다 따로 결제할 수 있습니다. 같은 사업으로 새 문서를 만들면 답변을 이어받을지 새로 시작할지 선택할 수 있습니다.",
